...
{
public:
    SvgTheme(const QString& fileName) : renderer_m(new QSvgRenderer(fileName)) {}
    ~SvgTheme() { delete renderer_m; }
    QSvgRenderer* renderer() { return renderer_m; }

private:
    QSvgRenderer* renderer_m;
};
